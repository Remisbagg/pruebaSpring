...
public interface IFriendRequestRepository extends JpaRepository<FriendRequest, Long> {
    ...
    @Query("select new com.back.dto.response.FriendRequestDTO(r.id, r.receiver.id, r.receiver.avatar, " +
    ...
    @Query("select new com.back.dto.response.FriendRequestDTO(r.id, r.sender.id, r.sender.avatar, " +
